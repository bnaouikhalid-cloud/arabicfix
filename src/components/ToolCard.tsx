...
export const ToolCard: React.FC<ToolCardProps> = ({ tool, currentLang, onSelect }) => {
  ...
  return (
    <div
      ...
      className="bg-white border border-[#E2E8F0] p-5 rounded-2xl shadow-xs hover:shadow-md hover:border-[#2563EB]/50 transition-all duration-200 cursor-pointer relative group flex flex-col justify-between"
    >
      <div>
        ...
        {/* Title & Description */}
        <h4 className="font-bold text-lg mb-1 text-[#111827] group-hover:text-[#2563EB] transition-colors tracking-tight line-clamp-1">
          {tool.name[currentLang]}
        </h4>
        <p className="text-sm text-[#64748B] leading-snug line-clamp-2 mb-2">
